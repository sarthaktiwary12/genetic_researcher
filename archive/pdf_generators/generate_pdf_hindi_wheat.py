"""Generate a fancy PDF from the Hindi Wheat FINAL_REPORT with CONFIDENTIAL markings and Devanagari support."""

import markdown
from weasyprint import HTML, CSS
import os

REPORT_PATH = "ExRNA_Ag_Final_Report_CONFIDENTIAL_Long_Wheat_HINDI.md"
OUTPUT_PATH = "ExRNA_Ag_Final_Report_CONFIDENTIAL_Long_Wheat_HINDI.pdf"
...
<head>
<meta charset="UTF-8">
<title>ExRNA-Ag गोपनीय प्रतिवेदन — गेहूँ</title>
</head>
<body>
...
<div class="cover-page">
    ...
    <div class="cover-border">
        <div class="cover-content">
            ...
            <h1 class="cover-title">बैक्टीरियल बाह्यकोशिकीय RNA-मध्यस्थित<br>गेहूँ (<em>Triticum aestivum</em>) बीज<br>अंकुरण का पुनर्क्रमादेशन</h1>
...
# Generate PDF
print("Generating Hindi Wheat PDF...")
