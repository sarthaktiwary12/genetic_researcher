...
- **Network centrality**: High — chromatin remodeling affects entire transcriptional pr
[... truncated]
...
- **Direct receptor engagement**: Plants possess pattern 
[... truncated]
...
**Expected result if EPS osmopriming is the primary confounder**: Treatment A and Treatment B perform equivalently (no significant difference in germination metrics). Both outperform Treatment D. The EPS matrix, not the RNA, drives the phenotype. [KNOWN: osmopriming mechanism is well-established; Papa
[... truncated]
